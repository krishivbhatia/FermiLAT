...
df1 = pd.DataFrame([
    ...
    columns=['Classification-NN-'+str(tot_iter), '0.95-1.0', '0.90-0.95', '0.8-0.9', '0.7-0.8', '0.6-0.7', '0.5-0.6'])
...
df2 = pd.DataFrame([
    ...
    columns=['Classification-NN-'+str(tot_iter), '0.0-0.05', '0.05-0.1', '0.1-0.2', '0.2-0.3', '0.3-0.4', '0.4-0.5'])

# plot grouped bar chart
ax1 = df1.plot(x='Classification-NN-'+str(tot_iter),
        kind='bar',
        stacked=False,
...
ax2 = df2.plot(x='Classification-NN-'+str(tot_iter),
        kind='bar',
        stacked=False,
